...
namespace FixPartRepairs
{
    ...
    public partial class FixPartRepairsEntities : DbContext
    {
        public FixPartRepairsEntities()
            : base("name=FixPartRepairsEntities")
        {
        }
        ...
        public DbSet<MESC1TS_EDI_ERROR1> MESC1TS_EDI_ERROR1 { get; set; }
        public DbSet<MESC1TS_EDI_LINEITEM> MESC1TS_EDI_LINEITEM { get; set; }
        public DbSet<MESC1TS_EDI_LINEITEM1> MESC1TS_EDI_LINEITEM1 { get; set; }
