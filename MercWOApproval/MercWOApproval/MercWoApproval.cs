...
{
    public partial class MercWoApproval : ServiceBase
    {
        private AutoResetEvent AutoEventInstance { get; set; }
        private MercWoApproval TimerInstance { get; set; }
        private Timer StateTimer { get; set; }
        public int TimerInterval { get; set; }
        Thread Worker;
        AutoResetEvent StopRequest = new AutoResetEvent(false);
        public static LogEntry logEntry = new LogEntry();
        public MercWoApproval()
        {
            InitializeComponent();
        }
        ...
        public void StartOperation(Object stateInfo)//this is function (delegate) where the actuall operation starts and executed after each time interval
        {
            ...
            try
            {
                logEntry.Message = "MercWOApprovalService Started";
                Logger.Write(logEntry);
                MercWOApprovalBAL objWOUpdate = new MercWOApprovalBAL();
                objWOUpdate.StartProcessing();
