...
namespace ManageUserService
{
    ...
    public partial class ManageUserServiceEntities : DbContext
    {
        public ManageUserServiceEntities()
            : base("name=ManageUserServiceEntities")
        {
        }
        ...
        public DbSet<EstLifeCycle_ApprovalCanceled_old> EstLifeCycle_ApprovalCanceled_old { get; set; }
        public DbSet<EstLifeCycleAnalysi> EstLifeCycleAnalysis { get; set; }
        public DbSet<EstLifeCycleAnalysis_old> EstLifeCycleAnalysis_old { get; set; }
        public DbSet<EstLineItemAnalysi> EstLineItemAnalysis { get; set; }
        public DbSet<EstLineItemAnalysis_old> EstLineItemAnalysis_old { get; set; }
        public DbSet<MESC1TS_AUDIT_DETAILS> MESC1TS_AUDIT_DETAILS { get; set; }
        public DbSet<MESC1TS_AUDIT_HISTORY> MESC1TS_AUDIT_HISTORY { get; set; }
        public DbSet<MESC1TS_EDI_ERROR2> MESC1TS_EDI_ERROR2 { get; set; }
        public DbSet<MESC1TS_EDI_LINEITEM2> MESC1TS_EDI_LINEITEM2 { get; set; }
        public DbSet<MESC1TS_EXCLUSNLIST> MESC1TS_EXCLUSNLIST { get; set; }
        public DbSet<MESC1TS_WODAMAGE> MESC1TS_WODAMAGE { get; set; }
        public DbSet<WO_VALIDATION> WO_VALIDATION { get; set; }
        public DbSet<MESC1TS_AUDITRESULT_CODE> MESC1TS_AUDITRESULT_CODE { get; set; }
        public DbSet<MESC1TS_AUDITSTATUS_CODE> MESC1TS_AUDITSTATUS_CODE { get; set; }
        public DbSet<MESC1TS_LOCATION_BackUp_04052019> MESC1TS_LOCATION_BackUp_04052019 { get; set; }
        public DbSet<SEC_AUTHGROUP_USER_backup25112017> SEC_AUTHGROUP_USER_backup25112017 { get; set; }
        public DbSet<SEC_USER_backup25112017> SEC_USER_backup25112017 { get; set; }
        public DbSet<SEC_USER_bkup_2017> SEC_USER_bkup_2017 { get; set; }
    }
}
